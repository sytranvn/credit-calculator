...
<ol type="a">
	<li>
		...
		materials (information or software) on ĐTTX HCMUS's web site for
		...
		<ol type="i">
			...
			<li>
				...
				software contained on ĐTTX HCMUS's web site;
			</li>
			<li>
	...
	<li>
		...
		these restrictions and may be terminated by ĐTTX HCMUS at any
...
<ol type="a">
	<li>
		The materials on ĐTTX HCMUS's web site are provided "as is".
		ĐTTX HCMUS makes no warranties, expressed or implied, and hereby
		disclaims and negates all other warranties, including without
		limitation, implied warranties or conditions of merchantability,
		fitness for a particular purpose, or non-infringement of
		intellectual property or other violation of rights. Further,
		ĐTTX HCMUS does not warrant or make any representations
		concerning the accuracy, likely results, or reliability of the
		use of the materials on its Internet web site or otherwise
...
<p>
	In no event shall ĐTTX HCMUS or its suppliers be liable for any damages
	(including, without limitation, damages for loss of data or profit, or
	due to business interruption,) arising out of the use or inability to
	use the materials on ĐTTX HCMUS's Internet site, even if ĐTTX HCMUS or a
	ĐTTX HCMUS authorized representative has been notified orally or in
...
<p>
	The materials appearing on ĐTTX HCMUS's web site could include
	technical, typographical, or photographic errors. ĐTTX HCMUS does not
	warrant that any of the materials on its web site are accurate,
	complete, or current. ĐTTX HCMUS may make changes to the materials
	contained on its web site at any time without notice. ĐTTX HCMUS does
...
<p>
	ĐTTX HCMUS has not reviewed all of the sites linked to its Internet web
	site and is not responsible for the contents of any such linked site.
	The inclusion of any link does not imply endorsement by ĐTTX HCMUS of
...
<p>
	ĐTTX HCMUS may revise these terms of use for its web site at any time
...
<p>
	Any claim relating to ĐTTX HCMUS's web site shall be governed by the
	laws of the State of ĐTTX HCMUS without regard to its conflict of law
	provisions.
</p>
